...
Change. If you're not finding the answer to your question on this website, this page will help you. If you're still unsure, don't hesitate to send [your question to us](mailto\:docsearch@algolia.com) directly.
...
You should use [the dedicated web interface](https://crawler.algolia.com/) to make any changes to your index.
...
1. Your index settings are up to date (you'll see a banner in [the search preview](/docs/manage-your-crawls/#search-preview) if not)

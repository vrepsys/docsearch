...
:::info
&#x20;The following content is for [**DocSearch v3**](https://github.com/algolia/docsearch/). If you are using [**DocSearch v2**](https://github.com/algolia/docsearch/tree/master), see the [**legacy**](/docs/legacy/dropdown) documenta tion.
:::

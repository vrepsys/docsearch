...
Your Algolia Sesdafsadfarch API key.
...
Useful for transforming the [Algolia Search Client](https://www.algolia.com/doc/api-client/getting-started/what-is-the-api-client/javascript/?client=javascript), for example to [debounce search queries](https://codesandbox.io/s/docsearch-v3-debounced-search-gnx87)

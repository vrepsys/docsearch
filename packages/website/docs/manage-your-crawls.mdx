...
Head over to the `Overview` se   ction to `start`, `restart` or `pause` your crawls and view a real-time summary.
...
<div className="uil-ta-center">
  <img src={useBaseUrl('img/assets/crawler-search-preview.png')} alt="Algolia Crawler creation page" />
</div>

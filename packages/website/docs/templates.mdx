...
To help you create the best search experience for your users, we provide config templates for multiple we bsites generators. If you'd like to add a new template to our list, or believe we should update  an existing one, please [send us an email](mailto\:docsearch@algolia.com) or [open a pull request](https://github.com/algolia/docsearch).
...
<div className="uil-ta-center">
  <img src={useBaseUrl('img/assets/new-crawler-creation.png')} alt="Algolia Crawler creation page" />
</div>
...
<details>
  <summary>docusaurus-v3.js</summary>
